...
| --- | --- | --- |
| api | Пользователи, точки, геокодинг, справочники, инфраструктура, события и история рейтинга, авторизация Mini App; плановый пересчёт — целевая возможность | Собственная PostgreSQL через pgxpool; OSRM для рейтинга |
